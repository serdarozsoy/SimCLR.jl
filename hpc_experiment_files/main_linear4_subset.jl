...
for epoch in 1:epochs
    ...
    result_name = string("linear_results/sub0.01_testacc_pre_", pretrained_epoch, ".jld2")
    result_name2 = string("linear_results/sub0.01_trainloss_pre_", pretrained_epoch, ".jld2")
    result_name3 = string("linear_results/sub_0.01_testloss_pre_", pretrained_epoch, ".jld2")
    ...
    if mod(epoch, epochs) == 0
      linear_model_name = string("linear_results/sub0.01_model_linear_pre_", pretrained_epoch, ".jld2") 
